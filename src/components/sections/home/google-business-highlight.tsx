...
export default function GoogleBusinessHighlight() {
  return (
    <div className="max-w-md mx-auto bg-white rounded-lg overflow-hidden shadow-lg border border-gray-200">
      ...
      <div className="p-4">
        <h1 className="text-xl font-bold text-gray-800">Rezanje in vrtanje betona, Iztok Ziherl, s.p.</h1>
        ...
        <div className="flex items-center mt-2">
          ...
          <span className="ml-2 text-blue-600 text-sm">10 mnenj</span>
        </div>
        ...
        <div className="mt-2 text-gray-600">
          <p className="flex items-center">
            ...
            Gradbenik v Ljubljani
          </p>
        </div>
        
        {/* Service Info */}
        <div className="mt-4 p-3 bg-gray-50 rounded-md">
          <p className="font-medium text-gray-800">Možnosti storitve:</p>
          <ul className="mt-1">
            <li className="flex items-center text-gray-600 text-sm mt-1">
              <ChevronRight size={16} className="mr-1 text-gray-400" />
              Storitve na lokaciji
            </li>
            <li className="flex items-center text-gray-600 text-sm mt-1">
              <ChevronRight size={16} className="mr-1 text-gray-400" />
              Ne ponujajo spletnih terminov
            </li>
          </ul>
        </div>
      </div>
      
      {/* Action Buttons - Updated to single full-width CTA */}
      <div className="px-4 pb-4">
        <a 
          href="https://g.co/kgs/cSvTLm3" 
          target="_blank" 
          rel="noopener noreferrer" 
          className="flex items-center justify-center w-full py-2 px-4 bg-blue-500 text-white rounded-md font-medium hover:bg-blue-600 transition-colors"
        >
          <Globe size={16} className="mr-2" />
          Obišči Google Profil
        </a>
      </div>
    </div>
  );
